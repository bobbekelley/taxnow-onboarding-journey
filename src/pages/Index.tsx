      ...
      <div className="container max-w-6xl mx-auto px-4 py-16 relative">
        ...
        duration: 0.8
          ...
          scale: 0.98
            ...
            <button className="px-8 py-4 bg-gradient-to-r from-primary via-violet-500 to-purple-600 text-white rounded-full font-medium shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 border border-white/20">Connect Your Account</button>
          </motion.div>
