  ...
  return <div className="min-h-screen bg-gradient-to-br from-violet-100 via-purple-50 to-pink-50">
      <div className="container max-w-4xl mx-auto px-4 py-12">
        ...
        y: 0
          ...
          {/* Security Badge */}
          <motion.div className="flex items-center justify-center gap-2 text-sm text-primary/90 bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 w-fit mx-auto hover:bg-white/60 transition-colors duration-300" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
        ...
        delay: 0.4
          ...
          <div className="space-y-2">
            ...
            <Input id="date" type="text" value={currentDate} readOnly className="w-full bg-gray-50 cursor-not-allowed" />
          </div>
          ...
          <div className="flex justify-between items-center pt-4">
            ...
            <div className="flex gap-3">
              <button type="button" onClick={handleDownload} disabled={!name || !agreed} className="px-6 py-2 bg-gray-200 text-gray-700 rounded-full font-medium hover:bg-gray-300 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
                Download Form
              </button>
